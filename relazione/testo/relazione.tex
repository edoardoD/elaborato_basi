...
\subsection*{Aggiunta nuovo record cliente e guida, visita \ref{cell:op2}}
...
\subsection*{Aggiunta nuovo gruppo }
...
\begin{table}[H]
	...
	\end{tabularx}
\end{table}
\subsection*{Inserimento delle competenze di una guida}
...
\begin{table}[H]
	...
	\end{tabularx}
\end{table}
\subsection*{Acquisto biglietto per un determinato evento e valutazione sconto}
...
precedenza navigare lo schema vino ad evento per definire il prezzo del
biglietto, per tanto più avanti verrà indicato l'attributo prezzo in biglietto.
\subsection*{Visualizzazione dei biglietti invenduti per un determinato evento}
...
\subsection*{Evento che ha venduto di più a fine anno commerciale}
