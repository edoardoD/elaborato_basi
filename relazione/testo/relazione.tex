...
\begin{lstlisting}[style=codeStyle,language=SQL,caption={popolamento della tabella COMPETENZE}]
...
\begin{lstlisting}[style=codeStyle,language=SQL,caption={popolamento tabella EVENTI}]
...
\lstinputlisting[style=codeStyle, language=SQL,caption={si noti dalla linea 90 l'aterazione delle tabelle una volta create per gestire le relazioni definite nel report}]{../../SQL/visite_turistiche.sql}
\begin{figure}[H]
	\centering
