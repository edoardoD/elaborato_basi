...
\begin{table}[H]
	\begin{center}
		\begin{tabularx}{\textwidth}{|>{\centering\arraybackslash}X|>{\centering\arraybackslash}X|>{\centering\arraybackslash}X|>{\centering\arraybackslash}X|}
			\hline
			\rowcolor{red} \uppercase{concetto} & \uppercase{costrutto}                       & \uppercase{descrizione}    & \uppercase{volume} \\
			\hline
			\uppercase{cliente}                 & \uppercase{e}                               & -                          & 100000             \\
			\hline
			\uppercase{biglietto}               & \uppercase{e}                               & -                          & 80000              \\
			\hline
			\uppercase{gruppo}                  & \uppercase{e}                               & -                          & 16000              \\
			\hline
			\uppercase{evento}                  & \uppercase{e}                               & -                          & 3200               \\
			\hline
			evento                              & situazione specifica dato un luogo e orario & visita-guidata, escursioni & visita, gruppi     \\
			\hline
			\uppercase{visite}                  & \uppercase{e}                               & -                          & 640                \\
			\hline
		\end{tabularx}
		\caption{bella per noi }
	\end{center}
\end{table}
